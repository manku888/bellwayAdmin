                                    ...
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('check') }}">
                                            ...
                                            <div class="form-floating mb-3 position-relative">
                                                ...
                                                <button type="button" class="btn btn-light btn-sm position-absolute top-50 end-0 translate-middle-y me-3" id="togglePassword" style="border: none;">
                                                    <i class="fa-solid fa-eye" id="showIcon" style="display: none;"></i>
                                                    <i class="fa-solid fa-eye-slash" id="hideIcon"></i>
                                                </button>
                                            </div>
